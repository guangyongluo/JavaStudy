...
public class Lists {
  ...
  public static void basicTest(List<String> a) {
    ...
    System.out.println("Before invoked Countries.names(25) : " + a);
    // Add a collection:
    a.addAll(Countries.names(25));
    System.out.println("After invoked Countries.names(25) : " + a);
    // Add a collection starting at location 3:
    a.addAll(3, Countries.names(25));
    System.out.println("After invoked a.addAll(3, Countries.names(25)) : " + a);
