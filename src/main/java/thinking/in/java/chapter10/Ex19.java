...
public class Ex19 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ei.getI());
		Ex19.Ex19Inner.Ex19InnerInner eii = ei.new Ex19InnerInner();
	}
}

/*
 * compiler produces: Ex19$Ex19Inner$Ex19InnerInner.class Ex19$Ex19Inner.class
 * Ex19$Ex19Nested$Ex19NestedNested.class Ex19$Ex19Nested.class Ex19.class
 */
